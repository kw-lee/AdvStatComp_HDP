...
As in \ref{eqn:phi_cond-biv}, tranformation, $Y=LX$ provides $m$-dimensional multivariate normal prabability as the product of s $d$-dimensional multivariate normal probabilities as below.
...
Equation \ref{eqn::phi_cond-ddim} is implemented as below.
...
\subsection{d-dimensional truncated expectations}
...
\begin{proof}
	...
	\end{equation}
	With integration \ref{eqn:proof} from $\mathbf{a}$ to $\mathbf{b}$,
