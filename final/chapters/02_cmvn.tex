...
$$K_N=\{i\mathbf{q}\text{ mode }1,i=1,\cdots,N\}$$,
...
Cholesky decomposition and few tranformation gives (\ref{eqn:qmc}), and algorithm \label{ref:QMC} implemented (\ref{eqn:qmc}) at $L_N$ $ns$ times.
