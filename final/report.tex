...
{\large Department of Statistics, Seoul National University}\\[0.5cm]

{\large Advanced Statistical Computing @ SNU}\\[0.5cm]

% Title
\rule{\linewidth}{0.5mm} \\[0.4cm]
{ \huge \bfseries Hierarchical-block conditioning approximations for high-dimensional multivariate normal probabilities \\[0.4cm] }
